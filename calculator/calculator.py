...
if __name__ == "__main__":
    ...
    slash = Button(gui, text="/", fg = 'black', bg = 'red', command = lambda: press("/"), height = 1, width = 7)
    slash.grid(row = 4, column = 3)
    empty = Button(gui, text="", fg = 'black', bg = 'red', command = clear, height = 1, width = 7)
